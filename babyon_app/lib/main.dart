        ...
        builder:
            (ctx, auth, _) => MaterialApp(
              ...
              routes: {
                ...
                '/create_job_posting': (context) => const CreateJobPostingScreen(),
                '/my_job_postings':
                    (context) =>
              ...
              onGenerateRoute: (settings) {
                ...
                // 구인글 수정 페이지 (arguments 기반)
                if (settings.name == '/edit_job_posting') {
                  final jobPosting = settings.arguments;
                  if (jobPosting != null && jobPosting is JobPosting) {
                    return MaterialPageRoute(
                      builder: (context) => EditJobPostingScreen(
                ...
                // 구인글 상세 페이지 (arguments 기반)
                if (settings.name == '/job_posting_detail') {
                  final postingId = settings.arguments;
                  if (postingId != null && postingId is int) {
                    return MaterialPageRoute(
                      builder: (context) => JobPostingDetailScreen(
                        jobPostingId: postingId,
                      ),
                    );
                  }
                ...
                // 지원서 작성 페이지 (arguments 기반)
                if (settings.name == '/create_job_application') {
                  final postingId = settings.arguments;
                  if (postingId != null && postingId is int) {
                    return MaterialPageRoute(
                      builder: (context) => CreateJobApplicationScreen(
                        jobPostingId: postingId,
                      ),
                    );
                  }
