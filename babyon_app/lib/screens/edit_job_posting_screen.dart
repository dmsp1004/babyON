...
class _EditJobPostingScreenState extends State<EditJobPostingScreen> {
  ...
  late TextEditingController _ageOfChildrenController;
  late TextEditingController _numberOfChildrenController;

  DateTime? _startDate;
  DateTime? _endDate;
  late String _jobType;
  late int _requiredExperienceYears;
  ...
  void initState() {
    ...
    _hourlyRateController = TextEditingController(
      text: NumberFormat('#,###').format(widget.jobPosting.hourlyRate.toInt()),
    );
    _ageOfChildrenController = TextEditingController(text: widget.jobPosting.ageOfChildren);
    _numberOfChildrenController = TextEditingController(
      text: widget.jobPosting.numberOfChildren.toString(),
    );

    _startDate = widget.jobPosting.startDate;
    _endDate = widget.jobPosting.endDate;
    _jobType = widget.jobPosting.jobType;
    _requiredExperienceYears = widget.jobPosting.requiredExperienceYears;
  }
  ...
  Future<void> _submitForm() async {
    ...
    try {
      final updatedJobPosting = await _apiService.updateJobPosting(
        ...
        endDate: _endDate!,
        hourlyRate: double.parse(_hourlyRateController.text.replaceAll(',', '')),
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('구인글이 성공적으로 수정되었습니다.'),
